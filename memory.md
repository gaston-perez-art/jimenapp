...
> **Reemplazado el 27/08/2026, mismo día, por pedido de Jimena: el adicional pasó a ser su propio plan.** La franja al pie de la tarjeta única desapareció y ahora hay **dos tarjetas en paralelo** —"Método Raíz" y "Método Raíz + En vivo"— y en la segunda la clase en vivo **sí es el item 08**. La advertencia de arriba sigue valiendo pero cambió de lugar: prometer que está incluido es correcto en el plan 2, porque el plan 2 lo incluye; lo que no puede pasar es que el item 08 aparezca en la tarjeta del plan base.
>
