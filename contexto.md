...
- **Fecha de lanzamiento: 23/08/2026, con dominio propio** (decisión de Gastón del 17/08/2026). El dominio es **`entrenaconjime.com`**, comprado el 19/08/2026 en Cloudflare. El hosting sigue siendo GitHub Pages, que sirve `main/docs`; falta apuntar el DNS y poner el `CNAME` en `docs/`. Ver `memory.md` y `gantt.md`.
