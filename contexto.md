...
- **Oferta y precio vigentes (23/09/2026).** **El sitio no publica ningún precio, ni para Argentina ni para el exterior**: el bloque del programa dice "Consultá tu precio de lanzamiento" con un botón directo a WhatsApp, y el valor lo cuenta Jimena en privado. Reemplaza al esquema del 21/09 (USD 350 internacional), que a su vez reemplazó a la estrategia de fundadoras del 27/08 (`estrategia/estrategia-de-precios-metodo-raiz.docx`, desactualizado en la parte de precio). La clase en vivo 1 a 1 sigue siendo **un segundo plan, "Método Raíz + Tu entrenadora en vivo"**, también sin precio. El seguimiento real es: **planilla de reporte y videos de técnica cada semana**, revisión de fotos, medidas y peso **una vez por mes**, videollamada 1 a 1 **mensual**, y WhatsApp permanente. Se vende además una **gift card** con enlace propio (`/regalo/`), ver `memory.md`.
