...
- **Oferta y precio vigentes (21/09/2026).** Reemplaza a la estrategia de fundadoras/etapas del 27/08/2026 (`estrategia/estrategia-de-precios-metodo-raiz.docx`, ahora desactualizado en la parte de precio). Precio único y fijo: **USD 350/mes internacional**, sin tachado, sin cupo, sin fecha de cierre. **Argentina no ve ningún número en el sitio**: el bloque de precio dice "Consultá tu precio de lanzamiento" con un botón directo a WhatsApp, y el valor se lo pasa Jimena en privado. La clase en vivo 1 a 1 sigue siendo **un segundo plan, "Método Raíz + Tu entrenadora en vivo", con su propia tarjeta al lado de la del programa base**, sin precio publicado (el valor se cuenta en la entrevista inicial). El seguimiento real es: **planilla de reporte y videos de técnica cada semana**, revisión de fotos, medidas y peso **una vez por mes**, videollamada 1 a 1 **mensual**, y WhatsApp permanente. La detección de Argentina sigue siendo por zona horaria del navegador (`Intl.DateTimeFormat`), mismo mecanismo que ya existía; lo implementado y lo que falta, en `memory.md` y `backlog.md`.
