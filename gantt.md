...
1. **El dominio va primero y no puede esperar al 22.** Es la única tarea de la semana con un tiempo de espera que no depende de nadie: después de apuntar el DNS, GitHub Pages tarda **hasta 24 horas** en emitir el certificado HTTPS. Lanzar el 23 sin candado en el navegador, en una página que pide escribir por WhatsApp, es exactamente el tipo de detalle que hace dudar a una clienta. **Resuelto entero el 19/08: `entrenaconjime.com` comprado, apuntado y en vivo con HTTPS.** El riesgo que motivaba esta nota —las 24h de espera por el certificado— no se materializó: se emitió en menos de un minuto. El lanzamiento del 23 ya no depende de esto.
...
| @gaston | Apuntar DNS y `CNAME` | ✅ En vivo en **https://entrenaconjime.com** con HTTPS (19/08) |
| @gaston | Instalar analytics | ✅ GA4 midiendo visitas y clics a WhatsApp (19/08) |
...
**23-24/09:** header sin símbolo y favicon "J." · proceso con maquetas vivas (chat, plan, gráfico) también en mobile · planes: "El programa" recomendado con "A tu ritmo", "El programa + en vivo" con la clase 1 a 1, selector a la Netflix en mobile · menú hamburguesa arreglado, con despliegue tipo cortina · CTA de WhatsApp fijo en mobile · gift card con su primer caso real · el sitio deja de publicar precios.
