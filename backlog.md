...
- [~] 🟡 Testimonios: sumar fotos de las alumnas y hacerlos menos genéricos — benchmark pasado por Jimena: Coderhouse, reseñas de Airbnb, sariadnapascual.com. **Rediseñada y publicada (18/08/2026):** la grilla de tres tarjetas pasó a ser una cinta horizontal que se desplaza sola, se relentece al pasar el mouse y se puede arrastrar con el mouse o el dedo. Se sacaron el borde punteado (las tarjetas se llamaban "placeholder cards" y los testimonios reales se veían como maqueta), la tercera tarjeta inventada, y el título que prometía "cambios reales" sin mostrar ninguno. Ver `memory.md`. **Falta lo que depende de Jimena:** las fotos de Silvia y Verónica, y más citas — con solo dos, la cinta se ve repetida en pantallas anchas.
- [ ] 🔴 **Pedirle a Jimena los datos concretos de Silvia y Verónica:** hace cuánto entrenan, qué habían probado antes y qué cambió medible. Con eso entra el bloque destacado que ya está diseñado y verificado en `docs/_testimonios-preview.html` (foto en retrato, cita línea por línea ligada al scroll, y la franja de cifra-unidad-plazo que pide el patrón 1 del benchmark 03). Es la mejora de mayor impacto disponible para la sección y no depende de código.
