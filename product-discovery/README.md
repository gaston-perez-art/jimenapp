...
| `03-benchmark-world-class/` | Qué techo existe: 18 páginas de primer nivel, dentro y fuera del entrenamiento, y qué patrones comparten | **Abierto**, con ideas sin decidir |
